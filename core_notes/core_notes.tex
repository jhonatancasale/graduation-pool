...
% Second semester
\include{academic_guidance}
\include{calculus_II}
\include{introduction_to_computer_science_-_laboratory_practive_I}
\include{introduction_to_computer_science}
\include{linear_algebra}
\include{probrability_I}
\include{matrices_for_applied_statistics}
\include{statistical_inference}
